...

{
  ...
  Now fits OpenSSL 0.9.8e (Stable) with Indy 10
  July, 5th 2007 digivendo GmbH, Arvid Winkelsdorf

  Updated to OpenSSL 0.9.8g (Stable) with Indy 9 and Indy 10
    (rename IdSSLOpenSSLHeaders9.pas or IdSSLOpenSSLHeaders10.pas
     to IdSSLOpenSSLHeaders.pas depening on your Indy Version)
...
Const             
  ...
  OPENSSL_OPENSSL_VERSION_NUMBER = $0090805F;  // update to Indy SSL 0.9.8e --- by Arvid Winkelsdorf 06/05/2007
  OPENSSL_OPENSSL_VERSION_TEXT = 'OpenSSL 0.9.8e 23 Feb 2007';  {Do not localize}
...
const
  ...
  {$ELSE}
  SSL_DLL_name         = 'libssl32.dll';  {Do not localize}  // update to Indy SSL 0.9.7i --- by Liu Yang 2005.11.15
...
var
  ...
  // LIBEAY functions - open SSL 0.9.8e
...
const
  ...
  // update to Indy SSL 0.9.7i --- by Liu Yang 2005.11.15
  ...
  // end of fix (replace 'des_' with 'DES_')
