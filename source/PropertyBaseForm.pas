...
const
  WM_APPLYGLOBALFONTCHANGES = WM_USER + $200;
...
{*----------------------------------------------------------------------*
 | procedure TfmPropertyBase.WmApplyGlobalFontChanges                   |
 |                                                                      |
 | Handler for custom WM_APPLYGLOBALFONTCHANGES message.  This is sent  |
 | by TfmPropertyPageFont forms, which are used as a root for the       |
 | individual font/color TfmPropertyPageFontColor forms.                |
 |                                                                      |
 | Apply the font settings passed in the message to the child           |
 | color/font forms.                                                    |
 *----------------------------------------------------------------------*}
